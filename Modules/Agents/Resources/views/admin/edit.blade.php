...
@section('content') 
    <div class="panel panel-flat">
        ...
        <div class="panel-heading">
            <h5 class="panel-title">Edit Agents<a class="heading-elements-toggle"> <i class="icon-more"></i> </a></h5>
            <span   id="error-common"></span>
        </div>
        <div class="panel-body"> 
            <form action="#" id="agents_update" autocomplete="off" data-id="{{$user->id}}">
