...
@section('content') 
    <div class="panel panel-flat">
        ...
        <div class="panel-heading">
            <h5 class="panel-title">Create Owner<a class="heading-elements-toggle"> <i class="icon-more"></i> </a></h5>
			<span   id="error-common"></span>
        </div>
        <div class="panel-body"> 
            <form action="#" id="owner_create" autocomplete="off" >
                <div class="row"> 
