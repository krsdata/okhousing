...
function money_format_mo($money)
{
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12 property_container" onclick="ShowProperty({{$Fetchedproperty->id}})">
                                        <div class="property_wrapper">
                                            ...
                                            <div class="content_wrapper">
                                                ...
                                                <?php } ?></span> {{  money_format_mo($Fetchedproperty->prize) }}/- <small><?php echo (in_array('3',$selectedPropertyTypeId) || in_array('4',$selectedPropertyTypeId))?trans('countries::home/home.featured_per_month'):''; ?></small></h5>
