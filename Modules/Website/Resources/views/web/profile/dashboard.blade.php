...
.modalDelete.modal.fade{top:80px;} 
                    ...
                    <div class="right-box">
                        ...
                        <div class="profile-tab-box featured_properties">
                            <ul class="tab-head" role="tablist">
                                <li   role="presentation" id="Properties" >
                                    <a href="#properties2"  onclick="showProfile()"  aria-controls="properties" role="tab" data-toggle="tab">
                                        Profile
                                 </a>
                             </li>
...
<!-- Image crop modal -->
<div class="modal fade" id="CropModal" role="dialog"  data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button " class="btn btn-primary upload-result ">{{trans('countries::home/home.Save')}}</button>
          <button type="button" class="btn btn-default CloseModal" data-dismiss="modal">{{trans('countries::home/home.Cancel')}}</button>
        </div>
      </div>
