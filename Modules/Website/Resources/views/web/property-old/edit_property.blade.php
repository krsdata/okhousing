                                   ...
                                   @foreach($langugeDetails as $key=> $language)
                                    ...
                                    <div class="col-sm-6 col-xs-12" id="property_category">
                                                ...
                                                @if($property_categories)
                                                   <?php $selectedtype[] = $property_lists->category_id; ?>
                                                    @foreach($property_categories as $category)
                                                        <option value="{{ $category_op_id = ($category->parent_id == '')?$category->id:$category->parent_id}}" @if(in_array($category_op_id,$selectedtype)) selected @endif >{{$category->name}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                            <span  class="help-block"></span>   
                                        ...
                                        <div id="property_prize"> 
                                            <div class="input-field" >
                                                <input id="property_prize" name="property_prize" type="text" class="validate" required value="{{$property_lists->prize}}">
                                    ...
                                    <div class="col-sm-12 col-md-12">
                                         <div class="input-box" id="location">
                                              ...
                                              <input id="pac-input" name="location" type="text" placeholder="Enter a location" class="validate" style="font-size: 12px;" onclick="findAddress();" value="{{$property_lists->location}}" >
                             ...
                             <div class="step-form-box">
                                <div class="row">
                                    <div class="col-sm-3 col-xs-12">
                                        <div id="building_area">
                                            <div class="input-field">
                                                <input id="building_area" name="building_area" type="text" class="validate" required  value="{{$property_lists->building_area}}">
                                    ...
                                    <div class="col-sm-3 col-xs-12">
                                        <div id="land_area">
                                            <div class="input-field">
                                                <input id="land_area" name="land_area" type="text" class="validate" required  value="{{$property_lists->land_area}}" >
                                ...
                                <div class="row">    
                                    <div class="col-sm-3 col-xs-12">    
                                       <div  id="bedroom">
                                            <div class="input-field">
                                                <input type="number" id="bedroom1" value="{{$property_lists->bedroom}}" min="1" name="bedroom" required>
                                    ...
                                    <div class="col-sm-3 col-xs-12">    
                                       <div  id="bathroom">
                                            <div class="input-field">
                                                <input type="number" id="bathroom1" value="{{$property_lists->bathroom}}" min="1" name="bathroom" required>
                                    ...
                                    <div class="col-sm-4 col-xs-12">
                                     ...
                                     @foreach($neighbourhoods as $neighbourhood)
                                        <div class="input-field">
                                            ...
                                            <input name="in_km[]" id="km_id_{{$neighbourhood['id']}}"  type="text" class="form-control" placeholder="Enter km" style="width: 123px!important;" @foreach($selectedneigh as $selected)  @if($selected['neighbourhood_id']==$neighbourhood['id'] || $selected['neighbourhood_id']==$neighbourhood['parent_id']) value="{{$selected['kilometer']}}" @endif @endforeach>
