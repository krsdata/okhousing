            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-xs-12">
                    ...
                    <div class="right-box">
                        ...
                        <!--step 1-->
            <form action="#" id="property_list_add" autocomplete="off" enctype="multipart/form-data">
            @if(!empty($IPData))
                             ...
                             <div class="step-form-box">
                                ...
                                <div class="row">    
                                    ...
                                    <div class="col-sm-12 col-xs-12"  id="desc_{{$language['language_id']}}">
                                        ...
                                        <label for="desc_{{$language['id']}}">{{trans('countries::home/home.desc_in_eng')}}  {{trans('countries::home/home.'.$language['languages']['name'])}}*</label>
                                        <span  class="help-block"></span>
                                        </div>
                          ...
                          <div id="fifth_step" class="dispayNone">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">  
                                    <p style="text-align: center; color: red; font-family: bold;font-size: 14px;" class="imgErr" id="imgErr"> </p>
                                    <div class="uploader" id="file-upload-form" >             
                                        <input id="file-upload" type="file" name="images[]"  accept="image/*" multiple="true" />
                                        <input type="hidden" id="imgHid" value="yes"/>
                                    </div>
                                </div>
                            </div>
                        </div>
