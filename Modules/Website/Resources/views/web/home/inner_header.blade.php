                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <div class="nav-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="{{ URL('/property/Add')}}">{{trans('countries::home/home.listurpro')}}</a></li>
                            @else
                                 <li><a href="#" data-toggle="modal" data-target=".signup-box"  onclick="AddClassToBody()" >{{trans('countries::home/home.listurpro')}}</a></li>
                            @endif
                         @php
                                    $fcountry_lang=Session::get('fcountry_lang');
                                    $ffcountry_language = Session::get('fcountry_language');
                       ...
                       <?php if(Auth::guard('front_user')->user()) { ?>
                        ...
                        <?php } else { ?>
                            ...
                            <li>
                                <a href="#" id="opensignin" data-toggle="modal"  onclick="AddClassToBody()" data-target=".signin-box">
                                    <span class="icon"><img src="{{asset('public/web/images/icon-signin.png')}}" alt="" class="img-responsive"></span>
                                   {{trans('countries::home/home.sign_in')}} 
                                </a>
                            </li>
                            <li><a href="#" data-toggle="modal"   onclick="AddClassToBody()" data-target=".signup-box"><span class="icon"><img src="{{asset('public/web/images/icon-register.png')}}" alt="" class="img-responsive"></span>{{trans('countries::home/home.register')}}</a></li>
