                ...
                <div class="col-lg-6 col-sm-6 col-xs-12 grid-list-box">
                    <div class="right-box"> 
                        ...
                        <ul class="tab-head" role="tablist">
                                ...
                                <li role="presentation" id="Favorites" class="active"><a href="#favorites" aria-controls="favorites" role="tab" data-toggle="tab" aria-expanded="true">Favorites </a></li>
                        </ul>
                      </div>  
                      @endif
                    @if(!isset($Tab) || count($SearchList) == 0)
