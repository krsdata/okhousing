...
/* ************************************************************************* */  
    ...
    if($('#property_list').length){
        ...
        processing: true,
        serverSide: true,  
        ajax: base_url+"/o4k/Category/Categorylist",
            columns: [ 
                { data: 'id', name: 'id' },
                ...
                render: function (data, type, full) { 
                    return full.created_type.title;
                }
                },
                {
                data: "null",
                ...
                '<li><a href="'+base_url+'/o4k/Category/edit/'+full.id+'"><i class=" icon-pen"></i> Edit Category </a></li>';
                  u+='<li><a Onclick="return ConfirmDelete();" class="delete_single" href="'+base_url+'/o4k/Category/destroy/'+full.id+'"><i class="icon-trash"></i> Delete Category</a></li>';
                '</ul></li></ul>';                     
                return u;
                }
...
/*
  * create form 
     ...
     */
    $("#Category_list_create").submit(function(e)
    {
...
//        /* ------------------------------------------------------------------ */
        ...
        if(a==1 && b==1 && d==1)
        {
             ...
             $.ajax({
                    type: "POST",
                    url: base_url+"/o4k/Category/store", 
                    data: new FormData($('#Category_list_create')[0]),
                    dataType: "json",  
                    cache:false,
                    contentType: false,                   
                    processData:false,
     ...
     * params : Name,Status,Slug  
     */
 $("#Category_list_update").submit(function(e)
    {
...
//        /* ------------------------------------------------------------------ */
        ...
        if(a==1 && b==1 && d==1)
        {
            ...
            $.ajax({
                    type: "POST",
                    url: base_url+"/o4k/Category/update/"+$("#Category_list_update").attr('data-id'), 
                    data: new FormData($('#Category_list_update')[0]),
                    dataType: "json",  
                    cache:false,
                    contentType: false,                   
                    processData:false,
