...
@section('title', "Category Type management")
@section('css')
 ...
 @section('heading')
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li class="active"><a href="{{URL('/o4k/CategoryType')}}"><i class="icon-list position-left"></i>Property Type management</a></li>
        ...
        <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - Property Type management <small>Hello, {{Auth::guard('admin')->user()->name}}!</small></h4>
        </div>
