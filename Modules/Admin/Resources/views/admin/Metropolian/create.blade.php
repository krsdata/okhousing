        	 ...
        	 <form action="{{URL('/metropoloancity/store')}}" enctype="multipart/form-data" id="metropolian_list_create" autocomplete="off" method="POST" >
				...
				<div class="row">
						...
						<div class="form-group col-md-4" id="statusbox">
							...
							<input name="images[]" type="file" class="file-styled-primary" id="property_image" required="true" />
							 <p>Note : Image size shoulde be 276px x 329px </p>
						</div>
				...
				<div class="row">
						...
						<div class="form-group col-md-4" id="statusbox">
							<legend class="text-bold ">Featured Image</legend>
							<input name="images[]" type="file" class="file-styled-primary" id="property_image" required="true" />
							 <p>Note : Image size shoulde be 500px x 304px </p>
						</div>
				...
				<div class="row">
						...
						<div class="form-group col-md-4" id="statusbox">
							<legend class="text-bold ">Featured Image</legend>
							<input name="images[]" type="file" class="file-styled-primary" id="property_image" required="true" />
							<p>Note : Image size shoulde be 500px x 208px </p>
						</div>
				...
				<div class="row">
						...
						<div class="form-group col-md-4" id="statusbox">
							<legend class="text-bold ">Featured Image</legend>
							<input name="images[]" type="file" class="file-styled-primary" id="property_image" required="true" />
							<p>Note : Image size shoulde be 600px x 338px </p>
						</div>
				...
				<div class="row">
						...
						<div class="form-group col-md-4" id="statusbox">
							<legend class="text-bold ">Featured Image</legend>
							<input name="images[]" type="file" class="file-styled-primary" id="property_image" required="true" />
							<p>Note : Image size shoulde be 755px x 750px </p>
						</div>
				...
				<div class="row">
						...
						<div class="form-group col-md-4" id="statusbox">
							<legend class="text-bold ">Featured Image</legend>
							<input name="images[]" type="file" class="file-styled-primary" id="property_image" required="true" />
							<p>Note : Image size shoulde be 414px x 750px </p>
						</div>
				...
				<div class="row">
						...
						<div class="form-group col-md-4" id="statusbox">
							<legend class="text-bold ">Featured Image</legend>
							<input name="images[]" type="file" class="file-styled-primary" id="property_image" required="true" />
							<p>Note : Image size shoulde be 446px x 883px </p>
						</div>
				...
				<div class="row">
						...
						<div class="form-group col-md-4" id="statusbox">
							<legend class="text-bold ">Featured Image</legend>
							<input name="images[]" type="file" class="file-styled-primary" id="property_image" required="true" />
							<p>Note : Image size shoulde be 713px x 477px </p>
						</div>
