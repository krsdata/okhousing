 ...
 @section('heading')
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li class="active"><a href="{{URL('/o4k/CategoryType')}}"><i class="icon-list position-left"></i>Category Type management</a></li>
        ...
        <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - Category Type management <small>Hello, {{Auth::guard('admin')->user()->name}}!</small></h4>
        </div>
 ...
 @section('content') 
    <div class="panel panel-flat">
        ...
        <div class="panel-heading">
            <h5 class="panel-title">Category Type List<a class="heading-elements-toggle"> <i class="icon-more"></i> </a></h5>
        </div>
