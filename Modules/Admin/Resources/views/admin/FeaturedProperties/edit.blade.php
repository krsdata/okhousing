                            ...
                            <!---Property Name-->
                             <div class="form-group col-md-6 " id="propertybox">
                                        ...
                                        <div class="input-group">
                                                <input type="text" class="form-control" id="unique_property_id" name="unique_property_id" placeholder="search by Property ID Ex. {{$short_code}}-10001" value="{{$PropertyDetails->uid}}">
