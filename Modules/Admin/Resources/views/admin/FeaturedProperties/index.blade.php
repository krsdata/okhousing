        ...
        <div class="panel-heading">
            ...
            <div class="col-md-8 ">
                    <div class="input-group pull-right">
                        ...
                        <input type="hidden" name="FilterSubscriptionclick" id="FilterSubscriptionclick" value="0">
...
@section('js')
    ...
    $(".FilterSubscription").click(function(){
        ...
        var FilterSubscriptionclick = $("#FilterSubscriptionclick").val();
        FilterSubscriptionclick++;
        $("#FilterSubscriptionclick").val(FilterSubscriptionclick);
                ...
                $('.content-wrapper').block({
                    ...
                    success: function(response){
                       if(response.status==true){
                        ...
                        if($("#FilterSubscriptionclick").val() == 1)
                        {
                            $(".FilterSubscription").trigger("click");
                        }
                        else if($("#FilterSubscriptionclick").val() == 2)
                        {
                            $("#FilterSubscriptionclick").val("0");
                        }
