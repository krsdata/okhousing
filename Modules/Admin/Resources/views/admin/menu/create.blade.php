...
@section('content') 
    <div class="panel panel-flat">
        ...
        <div class="panel-heading">
            <h5 class="panel-title">Create Menu <a class="heading-elements-toggle"> <i class="icon-more"></i> </a></h5>
        </div>
		<div class="panel-body">
		<!--- Form -->
        <div class="row">
            <div class="col-md-12">
                <form action="#" id="menu_list_create" autocomplete="off" > 
                    ...
                    <!---Name-->
                        ...
                        <div class="form-group col-md-6" id="slugbox_en">
                            <label>Slug</label>
                                <input id="slug_en"  type="text" name="slug_en"  readonly class="form-control perm_slug" placeholder="Title Slug" >
                                 <span  class="help-block"></span> 
                        </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6" id="slugbox_{{$language->languages->lang_code}}">
                            <label>Slug</label>
                            <input  type="text" id="slug_{{$language->languages->lang_code}}" name="slug[]" readonly class="form-control perm_slug" placeholder="Title Slug"  >
                             <span  class="help-block "></span> 
                        </div>
                    </div>
                        @endforeach
