                   ...
                   <div class="row">
                       <input type="hidden" name="id" value="{{$SearchRadius->id}}">
                        <div class="form-group col-md-6" id="titlebox_en">
                            ...
                            <input  id= "radius" name="radius" min="1" type="number" class="form-control perm_text" placeholder="Enter radius" data-lang="en" value="{{$SearchRadius->radius}}" required="true">
...
@section('js')
   ...
   <script type="text/javascript" src="{{asset('Modules/Admin/Resources/assets/js/MobileappControles.js')}}"></script>
    ...
    $("#SearchRadiuslist_update").submit(function(e)
    {
