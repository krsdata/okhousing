...
@section('content') 
  <div class="panel panel-white"> 
    ...
    {!! Form::model($neighborhood, ['method' => 'PATCH', 'route' => ['neighborhood.update', $neighborhood->id],'class'=>'form-basic ui-formwizard user-form','id'=>'form_sample_3','enctype'=>'multipart/form-data']) !!}
