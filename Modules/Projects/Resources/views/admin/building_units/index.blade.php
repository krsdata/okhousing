 ...
 @section('heading')
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li class="active"><a href="{{URL('/o4k/projects/building_unit/')}}"><i class="icon-list position-left"></i> Building Units</a></li>
        ...
        <div class="heading-elements">
           <a type="button" href="{{ URL::to('o4k/projects/building_unit/create')}}" class="btn bg-primary-400 btn-labeled btn-rounded legitRipple"><b><i class="icon-plus3"></i></b> Add Building Unit</a>
       </div>
    </div>
@stop
