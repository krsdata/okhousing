...
<ul class="breadcrumb">
        ...
        <li><a href="{{ URL::to('/o4k/projects/land_unit')}}"><i class="icon-list position-left"></i>Land Units</a></li>
...
@section('heading')
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li><a href="{{URL('/o4k/projects/land_unit')}}"><i class="icon-list position-left"></i>Land Units</a></li>
            <li class="active">Edit</li>
        </ul>
                 ...
                 @if(isset($languages))
                            @foreach ($languages as $key => $value)
                               @if(\Illuminate\Support\Arr::exists($value, 'languages'))
                                ...
                                @php   $BuildingUnitsEach = Modules\Projects\Entities\LandUnits::where('language_id' ,$value['languages']['id'])->where('country_id',$value['created_country_id'])->whereNull('deleted_at')->where(function ($query) use ($land_unit) {
