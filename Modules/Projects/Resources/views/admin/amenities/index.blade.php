 ...
 @section('heading')
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li class="active"><a href="{{URL('/o4k/projects/amenities/')}}"><i class="icon-list position-left"></i> Amenities</a></li>
        ...
        <div class="heading-elements">
           <a type="button" href="{{ URL::to('o4k/projects/amenities/create')}}" class="btn bg-primary-400 btn-labeled btn-rounded legitRipple"><b><i class="icon-plus3"></i></b> Add Amenities</a>
       </div>
    </div>
@stop
