...
<ul class="breadcrumb">
        ...
        <li><a href="{{ URL::to('o4k/project_types')}}"><i class="icon-list position-left"></i>Project Types</a></li>
...
@section('heading')
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li><a href="{{URL('/o4k/project_types')}}"><i class="icon-list position-left"></i>Project Types</a></li>
            <li class="active">Create</li>
        </ul>
