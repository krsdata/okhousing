...
/* ************************************************************************* */  
    ...
    if($('#amenities_list').length){
        ...
        processing: true,
        serverSide: true,  
        ajax: base_url+"/o4k/projects/amenities/AdminAmenitiesList",
            columns: [ 
                { data: 'id', name: 'id' },
                { data: 'name', name: 'name' },
                ...
                '<li><a href="'+base_url+'/o4k/projects/amenities/edit/'+full.id+'"><i class=" icon-pen"></i> Edit Amenity</a></li>';
				 if(full.status=="0"){
                            u+= '<li ><a class="change_status"  href="'+base_url+'/o4k/projects/amenities/activate/'+full.id+'"><i class=" icon-eye"></i> Activate </a></li>';
                        }
                  else{
                            u+='<li  ><a class="change_status" href="'+base_url+'/o4k/projects/amenities/deactivate/'+full.id+'"><i class="  icon-eye-blocked"></i> Deactivate </a></li>';
                        } 
                u+='<li><a Onclick="return ConfirmDelete();" class="delete_single" href="'+base_url+'/o4k/projects/amenities/destroy/'+full.id+'"><i class="icon-trash"></i> Delete Amenity</a></li>';
                '</ul></li></ul>';                     
                return u;
                }
...
//        /* ------------------------------------------------------------------ */
        ...
        if(a==1 && b==1 && c==1 && d==1)
        {
           ...
           $.ajax({
                    type: "POST",
                    url:base_url+"/o4k/projects/amenities/store",
                    dataType: "json",
                    async: false, 
...
//        /* ------------------------------------------------------------------ */
        ...
        if(a==1 && b==1 && c==1)
        {
           ...
           $.ajax({
                    type: "POST",
                    url: base_url+"/o4k/projects/amenities/update/"+$("#amenity_update").attr('data-id'), 
