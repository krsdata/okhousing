...
*/
    ...
    {
        return view('projects::admin.amenities.index');
    }
...
*/
    ...
    public function create()
    {
        ...
        return view('projects::admin.amenities.create',compact('languages'));
    }
...
*/
    ...
    {
        $this->validate($request, ['name_en' => 'required|unique:project_amenities,name,NULL,id']);
        ...
        try {
            ...
            return response()->json(['status'=>true,'url'=>URL('/o4k/projects/amenities/'),'csrf' => csrf_token()]);
        }
        catch (\Exception $e) {
...
*/
    ...
    public function edit($id)
    {
        ...
        if($amenities==null){return redirect('/o4k/404');}
            ...
            $languages = Countrylangs::with('languages')->where('language_id','!=',1)->get();
            return view('projects::admin.amenities.edit', compact('languages','amenities'));
        }
    }
   ...
   public function destroy($id)
    {
        ...
        { 
            ...
            { 
                ...
                Amenities::where('parent_id',$id)->get()->each->delete();
            ...
            return redirect('o4k/projects/amenities');
        }
    }
	...
	public function activate($id)
	{
        ...
        { 
            ...
            { 
                ...
                $list = Amenities::where('parent_id',$id)->get();
                foreach($list as $l)
                {
                    $amenities = Amenities::find($l->id);
                    $amenities->status=1;
                    $amenities->save();
                }
