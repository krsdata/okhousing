...
use Modules\Projects\Entities\SliderOrder;
...
class AdminSliderController extends Controller
{
    ...
    {
        return view('projects::admin.slider.projects.index');
    }
    ...
    public function create()
    {
        ...
        if($short_code)
        {
            ...
            return view('projects::admin.slider.projects.create', compact('OrderList','short_code'));
        }
        else
        {
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, [
                'slider_element_id' => "unique:slider",
                'slider_element_id.unique' => 'Duplicate entry'
            ]);
        ...
        else
        {
                ...
                }else
                {
                    ...
                    return response()->json(['status'=>true,'url'=>URL('/o4k/sliderprojects/'),'csrf' => csrf_token()]);
                }
                catch (Exception $ex) {
    ...
    public function edit($id)
    {
        ...
        else
        {
           ...
           return view('projects::admin.slider.projects.edit', compact('property','PropertyDetails','short_code','OrderList','image','SelectedSliderPageOrder'));
        }
    ...
    public function update($id,Request $request)
    {
        ...
        $this->validate($request, [
                'slider_element_id' => "required" ,
                'Datetime' =>"required"],
            [
                'slider_element_id.unique' => 'Duplicate entry',
                'Datetime.ProperDate' => 'Select valid date'
            ]
        );
    ...
    public function destroy($id)
    {
        ...
        { 
            ...
            return redirect('o4k/sliderprojects');
        }
    }
