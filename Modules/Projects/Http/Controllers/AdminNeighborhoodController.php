...
*/
    ...
    {
        return view('projects::admin.neighborhood.index');
    }
...
*/
    ...
    public function create()
    {
        ...
        return view('projects::admin.neighborhood.create',compact('languages'));
    }
...
*/
    ...
    public function edit($id)
    {
        ...
        if($neighbourhood==null){return redirect('/o4k/404');}
            ...
            $languages = Countrylangs::with('languages')->where('language_id','!=',1)->get();
            return view('projects::admin.neighborhood.edit',compact('languages','neighbourhood'));
        }
    }
