...
*/
    ...
    {
        return view('projects::admin.building_units.index');
    }
...
*/
    ...
    public function create()
    {
        ...
        return view('projects::admin.building_units.create',compact('languages','countries'));
    }
...
*/
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return response()->json(['status'=>true,'url'=>URL('/o4k/projects/building_unit/'),'csrf' => csrf_token()]);
        }
        catch (\Exception $e) {
...
*/
    ...
    public function edit($id)
    {
        ...
        if($building_unit==null){return redirect('/o4k/404');}
            ...
            return view('projects::admin.building_units.edit',compact('languages','building_unit','countries'));
        }
    }
...
*/
    ...
    public function destroy($id)
    {
        ...
        { 
            ...
            return redirect('o4k/projects/building_unit');
        }
    }
    ...
    public function getlanguage($countryid,Request $request)
    {
        if($request->ajax())
        {
            ...
            {  
                 ...
                 $returnHTML = (String) view('projects::admin.building_units.section.dynamic',compact('languages'));
    ...
    public function getlanguage_edit($countryid,$parent_id,Request $request)
    {
        ...
        if($request->ajax())
        {
            ...
            {  
                 ...
                 $returnHTML = (String) view('projects::admin.building_units.section.dynamic_edit',compact('languages','parent_id'));
                return response()->json(['status'=>true, 'html'=>$returnHTML,'csrf' => csrf_token()]);
            }else{return response()->json(['status'=>false, 'message'=>'Oops something went wrong','csrf' => csrf_token()]);}
        }else{return redirect('/404');}
    }
