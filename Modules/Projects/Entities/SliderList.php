...
class SliderList extends Model
{
    ...
    public function property_data() {
        return $this->belongsTo("Modules\Projects\Entities\PropertyList","slider_element_id","id");
    }

    public function property_image_data() {
        return $this->belongsTo("Modules\Projects\Entities\PropertyImages","slider_element_id","property_id");
    }
    ...
    public function page_order() {
        return $this->belongsTo("Modules\Projects\Entities\SliderPageOrder","id","slider_id");
    }
