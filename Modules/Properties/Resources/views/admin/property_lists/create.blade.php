            ...
            <form action="#" id="property_list_create" autocomplete="off" >
				...
				<div class="row">
					...
					<div class="form-group col-md-6" id="typebox">
							...
							<select class="bootstrap-select" data-width="100%"  id="property_type"  name="type_id[]" multiple="multiple">
								<option value="" >Select</option>
			...
			<input type="hidden" name="bathroom_show" id="bathroom_show" value="1">
				...
				<div class="row">
						...
						<div class="form-group col-md-6" id="prizebox">
							<label>Price</label>
								<input id="property_prize" name="prize" type="text" class="form-control" placeholder="Enter Property Price">
								<span  class="help-block"></span> 
						</div>
						<!--- Status-->
					...
					<!---User Name-->
						<div class="form-group col-md-6" id="userbox">
							...
							<select class="bootstrap-select" data-width="100%" name="user_id" id="user_name">
								<option value="" >Select</option>
								<?php use Illuminate\Support\Arr; foreach($users as $user){

								 if( Arr::exists($user, 'created_users') )
							        {
							         ?>
				...
				<legend class="text-bold ">Property Details</legend>
					<!---Building Area-->
						<div class="form-group col-md-6 bulding_area_show" id="buildingbox">
						...
						<!----/* Building Area---->
						<!--- Building Unit-->
						<div class="form-group col-md-6 bulding_area_show" id="bunitbox">
				...
				<div class="row">
					<!---Land Area-->
						<div class="form-group col-md-6 landarea_show" id="landbox">
						...
						<!----/* Land Area---->
						<!--- Land Unit-->
						<div class="form-group col-md-6 landarea_show" id="lunitbox">
				...
				<div class="row">
					<!---Bedroom-->
						<div class="form-group col-md-6 bedroom_show" id="bedbox">
							<label>Bedroom</label>
						...
						<!----/* Bedroom---->
						<!--- Bathroom-->
						<div class="form-group col-md-6 bathroom_show " id="bathbox">
							...
							@foreach($neighbourhoods as $key=>$neighbourhood)
								<div class="form-group col-md-2" id="neighbourbox_{{$key+1}}">
									<label class="checkboxa" style="margin-top: 15px!important;">
										...
										<input name="in_km[]" id="km_id_{{$key+1}}"  type="text" class="form-control" placeholder="Enter meter" style="width: 123px!important;">
									<span  class="help-block"></span> 		 
								</div>
