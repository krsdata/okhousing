					 ...
					 <div class="row">
						...
						<div class="form-group col-md-6" id="bedroombox">
							...
							<select class="bootstrap-select" name="bedroom" id="bedroom"data-width="100%" required="true">
								<option value="1" @if($property_category->bedroom_show == '1') selected @endif   >Show</option>
								<option value="0" @if($property_category->bedroom_show == '0') selected @endif  >Hide</option>
							</select>
							 <span  class="help-block "></span>
						</div>
						...
						<div class="form-group col-md-6" id="bathroombox">
							...
							<select class="bootstrap-select" name="bathroom" id="bathroom"data-width="100%" required="true">
								<option value="1" @if($property_category->bathroom_show == '1') selected @endif  >Show</option>
								<option value="0"  @if($property_category->bathroom_show == '0') selected @endif >Hide</option>
							</select>
							 <span  class="help-block "></span>
						</div>
						...
						<div class="form-group col-md-6" id="buildingareabox">
							...
							<select class="bootstrap-select" name="buildingarea" id="buildingarea"data-width="100%" required="true">
								<option value="1" @if($property_category->bulding_area_show == '1'  ) selected @endif  >Show</option>
								<option value="0"  @if($property_category->bulding_area_show == '0'  ) selected @endif  >Hide</option>
							</select>
							 <span  class="help-block "></span>
						</div>
						...
						<div class="form-group col-md-6" id="landareabox">
							...
							<select class="bootstrap-select" name="landarea" id="landarea"data-width="100%" required="true">
								<option value="1" @if($property_category->landarea_show == '1'  ) selected @endif  >Show</option>
								<option value="0"  @if($property_category->landarea_show == '0'  ) selected @endif  >Hide</option>
							</select>
							 <span  class="help-block "></span>
						</div>
