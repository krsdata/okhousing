        ...
        <div class="row">
                            ...
                            <!---Property Name-->
                             <div class="form-group col-md-6 " id="propertybox">
                                        ...
                                        <div class="input-group">
                                                <input type="text" class="form-control" id="property_id" placeholder="search by Property ID Ex. {{$short_code}}-10001" name="unique_property_id"  value="{{$PropertyDetails->uid}}">
            ...
            <div class="col-md-4">
                <div class="propertyDetails" id="propertyDetails">
                    @if($image) <img src="{{ URL::asset('public/images/properties/'.$image->image) }}" class="img-responsive"  id="property_img"/> @endif
