 ...
 @section('heading')
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li class="active"><a href="{{URL('/o4k/property_types/')}}"><i class="icon-list position-left"></i>Slider  Property List</a></li>
        ...
        <div class="heading-elements">
           <a type="button" href="{{ URL::to('o4k/sliderproperties/create')}}" class="btn bg-primary-400 btn-labeled btn-rounded legitRipple"><b><i class="icon-plus3"></i></b> Add Slider Property List</a>
       </div>
    </div>
@stop
 ...
 @section('content') 
    <div class="panel panel-flat">
        ...
        <div class="panel-heading">
            <h5 class="panel-title">Slider Property List<a class="heading-elements-toggle"> <i class="icon-more"></i> </a></h5>
        </div>
