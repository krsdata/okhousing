		...
		<div class="row">
			<div class="langrow">
				...
				<div class="form-group col-md-6" id="unitbox_{{$value['languages']['id']}}">
					...
					<input id="unit_{{$value['languages']['id']}}" name="unit_{{$value['languages']['id']}}" type="text" class="form-control perm_text" placeholder="Enter Unit" >
				...
				<div class="form-group col-md-6 " id="slugbox_{{$value['languages']['id']}}">
					...
					<input  type="text" id="slug_{{$value['languages']['id']}}" name="slug_{{$value['languages']['id']}}" readonly class="form-control perm_slug" placeholder="Building Unit Slug"  >
					<span  class="help-block "></span> 
