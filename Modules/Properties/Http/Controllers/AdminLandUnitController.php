...
*/
    ...
    public function create()
    {
        ...
        return view('properties::admin.landunits.create',compact('languages','countries'));
...
*/
    ...
    public function edit($id)
    {
        ...
        if($land_unit==null){return redirect('/o4k/404');}
            ...
            return view('properties::admin.landunits.edit',compact('languages','land_unit','countries'));
        }
    ...
    public function getlanguage($countryid,Request $request)
    {
        if($request->ajax())
        {
            ...
            {  
                 ...
                 $returnHTML = (String) view('properties::admin.landunits.section.dynamic',compact('languages'));
    ...
    public function getlanguage_edit($countryid,$parent_id,Request $request)
    {
        ...
        if($request->ajax())
        {
            ...
            {  
                 ...
                 $returnHTML = (String) view('properties::admin.landunits.section.dynamic_edit',compact('languages','parent_id'));
                return response()->json(['status'=>true, 'html'=>$returnHTML,'csrf' => csrf_token()]);
            }else{return response()->json(['status'=>false, 'message'=>'Oops something went wrong','csrf' => csrf_token()]);}
        }else{return redirect('/404');}
    }
