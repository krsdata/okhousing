        ...
        this.each(function() {
            ...
            const retrieveFiles = (files) => {
                ...
                for (let index = 0; index < files.length; ++index) {
                    ...
                    fileSize = fileSize+ totalFiles[index].file.size;
                }
                if(fileSize > 10240000) {document.getElementById("imgErr").innerHTML ='Image size must not be more than 10 MB';document.getElementById("imgHid").value = "no";  }
                else{ document.getElementById("imgErr").innerHTML =' '; document.getElementById("imgHid").value = "yes"; }
            ...
            if(imgHid=='yes'){
              ...
              $(".preLoad").addClass( "addloader" );
                ...
                const  formDatas = new FormData($('#property_list_add')[0]);
                for (var i = 0; i < totalFiles.length; i++) {
                    formDatas.append(self.name, totalFiles[i].file);
                }
              $.ajax({
                    type: "POST",
            ...
            {
               $('.imgErr').html("Sorry, Something Went Wrong: Please try again later.");
            }
            
                
                
//                const  formDatas = new FormData($('#property_list_add')[0]);
//                formDatas.append("keysss", "valuesssssssss");
                
//                const inputs = this.querySelectorAll("input, textarea, select, button");
//                var  formData = new FormData($('#property_list_add')[0]);
//                formData.append("keysss", "valuesssssssss");
...
//            $("#property_list_add").submit(function(){
