...
*/
    ...
    {
        $this->validate($request, ['unit_en' => 'required|unique:property_building_units,unit,NULL,id','slug_en' => 'required|unique:property_building_units,slug,NULL,id']);
...
*/
    ...
    public function update($id, Request $request)
    {
        $this->validate($request, [
            'unit_en' => "required|unique:property_building_units,unit,$id,id",'slug_en' => "required|unique:property_building_units,slug,$id,id", 
        ]);
