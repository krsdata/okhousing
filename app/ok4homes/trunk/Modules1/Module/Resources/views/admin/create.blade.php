 ...
 @section('heading')
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li><a href="{{URL('/o4k/modules')}}"><i class="icon-list position-left"></i>Admin  Modules</a></li>
            <li class="active">Create</li>
        </ul>
 ...
 @section('content') 
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            <form action="#" id="module_create" autocomplete="off" >
                        ...
                        <div>
                            @foreach($countries as $country)
                                <label class="checkbox-inline">
                                    ...
                                    <input type="checkbox" class="checker border-success text-success-600 modulecountry  CheckboxStyle" name="countries[]" value="{{$country->id}}">
