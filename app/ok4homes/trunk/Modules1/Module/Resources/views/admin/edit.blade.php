...
<ul class="breadcrumb">
        ...
        <li><a href="{{ URL::to('o4k/modules')}}"><i class="icon-list position-left"></i> Modules</a></li>
 ...
 @section('heading')
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li><a href="{{URL('/o4k/modules')}}"><i class="icon-list position-left"></i> Modules</a></li>
            <li class="active">Edit</li>
        </ul>
     ...
     <div class="page-header-content">
        <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - Modules <small>Hello, {{Auth::guard('admin')->user()->name}}!</small></h4>
        </div>
 ...
 @section('content') 
    <div class="panel panel-flat">
        ...
        <div class="panel-heading">
            <h5 class="panel-title">Module Edit<a class="heading-elements-toggle"> <i class="icon-more"></i> </a></h5>
        </div>
        <div class="panel-body">
            <form action="#" id="module_update" autocomplete="off" data-id="{{$module->id}}">
            ...
            <!-- Status-->
                <div class="form-group col-md-6" id="module_status">
                    ...
                    <select class="bootstrap-select" name="status" data-width="100%">
                        <option value="1" selected @if($module->status== '1') selected @endif >Active</option>
            ...
            <!-- /* Parent Module-->	 
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input id="module_type" type="text" name="module_type" readonly class="form-control" value="Admin">
                    </div>
                    <!--/* Module Type -->
                    <!--Module Icon -->
                    <div class="form-group col-md-6">
                ...
                <div class="row">
                    <div class="col-md-12 text-right">
                       <!-- <button type="reset" class="btn btn-default legitRipple" id="reset">Reset <i class="icon-reload-alt position-right"></i></button>-->
                        <button type="submit" id="module_save" class="btn btn-primary legitRipple">Update Module <i class="icon-paperplane position-right"></i></button>
                    </div>	
                </div>
           <!-- /* Form action -->
	</form>
