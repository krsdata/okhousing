        ...
        <div class="builders-csp-slider">
            <div class="item ">
                <div class="item-contant container">
                    <div class="col-sm-10 col-xs-12 item-main-wrap">
                        <div class="img-box">
                            <div class="image" style="background-image: url(images/business-slide-1.jpg);"></div>
                        </div>
                        <div class="contant">
            ...
            <div class="item ">
                <div class="item-contant container">
                    <div class="col-sm-10 col-xs-12 item-main-wrap">
                        <div class="img-box">
                            <div class="image" style="background-image: url('public/web/images/business-slide-1.jpg');"></div>
                        </div>
                        <div class="contant">
                            <div class="project-details">
                                <div class="left-box">
