...
<!--                            <li class="dropdown">
                        ...
                        <?php } else { ?>
                        <li>
                                <a href="#" data-toggle="modal" data-target=".signin-box" data-backdrop="static" data-keyboard="false">
                                    <span class="icon"><img src="{{asset('public/web/images/icon-signin.png')}}" alt="" class="img-responsive"></span>
                                   {{trans('countries::home/home.sign_in')}} 
                                </a>
                            </li>
                            <li><a href="#" data-toggle="modal" data-target=".signup-box" data-backdrop="static" data-keyboard="false"><span class="icon"><img src="{{asset('public/web/images/icon-register.png')}}" alt="" class="img-responsive"></span>{{trans('countries::home/home.register')}}</a></li>
                        <?php } ?>
