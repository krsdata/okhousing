...
@section('title', "Admin Slider Owner List")
@section('css')
 ...
 @section('heading')
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li class="active"><a href="{{URL('/o4k/sliderowners/')}}"><i class="icon-list position-left"></i>Slider Owners List</a></li>
        ...
        <div class="heading-elements">
           <a type="button" href="{{ URL::to('o4k/sliderowners/create')}}" class="btn bg-primary-400 btn-labeled btn-rounded legitRipple"><b><i class="icon-plus3"></i></b> Add Slider Owners List</a>
       </div>
    </div>
@stop
 ...
 @section('content') 
    <div class="panel panel-flat">
        ...
        <div class="panel-heading">
            <h5 class="panel-title">Slider Owners List<a class="heading-elements-toggle"> <i class="icon-more"></i> </a></h5>
        </div>
