...
<ul class="breadcrumb">
        ...
        <li><a href="{{ URL::to('o4k/neighborhood')}}"><i class="icon-list position-left"></i>Amenities</a></li>
...
@section('heading')
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li><a href="{{URL('/o4k/neighborhood')}}"><i class="icon-list position-left"></i>Amenities</a></li>
            <li class="active">Create</li>
        </ul>
...
@section('content') 
    <div class="panel panel-flat">
        ...
        <div class="panel-heading">
            <h5 class="panel-title">Create Amenities<a class="heading-elements-toggle"> <i class="icon-more"></i> </a></h5>
        </div>
		<div class="panel-body">
		<!--- Form -->
            <form action="#" id="amenity_create" autocomplete="off" >
				<div class="row">
					<!---Name-->
						...
						<div class="form-group col-md-6" id="slugbox_en">
							<label>Slug</label>
								<input id="slug_en"  type="text" name="slug_en"  readonly class="form-control perm_slug" placeholder="Amenities Slug" >
								 <span  class="help-block"></span> 
						</div>
				</div>
					...
					<div class="row">
						...
						<div class="form-group col-md-6" id="slugbox_{{$language->languages->lang_code}}">
							<label>Slug</label>
							<input  type="text" id="slug_{{$language->languages->lang_code}}" name="slug[]" readonly class="form-control perm_slug" placeholder="Amenities Slug"  >
							 <span  class="help-block "></span> 
						</div>
					</div>
						@endforeach
...
@section('js')
   @section('js')
    ...
    <script type="text/javascript" src="{{asset('Modules/Properties/Resources/assets/js/amenitiesControles.js')}}"></script>
@stop
