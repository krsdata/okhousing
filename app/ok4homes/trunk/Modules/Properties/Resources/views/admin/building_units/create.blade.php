				...
				<div class="row">
					<!---Name-->
						...
						<div class="form-group col-md-6" id="slugbox_en">
							<label>Slug</label>
								<input id="slug_en"  type="text" name="slug_en"  readonly class="form-control perm_slug" placeholder="Building Unit Slug" >
								 <span  class="help-block"></span> 
						</div>
				</div>
					...
					<div class="row">
						...
						<div class="form-group col-md-6" id="slugbox_{{$language->languages->lang_code}}">
							<label>Slug</label>
							<input  type="text" id="slug_{{$language->languages->lang_code}}" name="slug[]" readonly class="form-control perm_slug" placeholder="Building Unit Slug"  >
							 <span  class="help-block "></span> 
						</div>
					</div>
						@endforeach
