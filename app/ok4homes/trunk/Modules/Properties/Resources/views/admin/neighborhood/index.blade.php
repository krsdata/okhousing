 ...
 @section('heading')
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li class="active"><a href="{{URL('/o4k/neighborhood/')}}"><i class="icon-list position-left"></i> Neighborhood</a></li>
        ...
        <div class="heading-elements">
           <a type="button" href="{{ URL::to('o4k/neighborhood/create')}}" class="btn bg-primary-400 btn-labeled btn-rounded legitRipple"><b><i class="icon-plus3"></i></b> Add Neighborhood</a>
       </div>
    </div>
@stop
 ...
 @section('content') 
    <div class="panel panel-flat">
        ...
        <div class="panel-heading">
            <h5 class="panel-title">Neighborhood List<a class="heading-elements-toggle"> <i class="icon-more"></i> </a></h5>
        </div>
        
        <div class="panel-body">
            <table class="table datatable-basic table-bordered table-hover" id="neighborhood_list">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Name</th>
