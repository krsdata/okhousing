...
<ul class="breadcrumb">
        ...
        <li><a href="{{ URL::to('o4k/agents')}}"><i class="icon-list position-left"></i> Utility</a></li>
...
@section('heading')
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li><a href="{{URL('/o4k/agents')}}"><i class="icon-list position-left"></i> Utility</a></li>
            <li class="active">Edit</li>
        </ul>
     ...
     <div class="page-header-content">
        <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - Utility <small>Hello, {{Auth::guard('admin')->user()->name}}!</small></h4>
        </div>
...
@section('content') 
    <div class="panel panel-flat">
        ...
        <div class="panel-heading">
            <h5 class="panel-title">Edit Utility<a class="heading-elements-toggle"> <i class="icon-more"></i> </a></h5>
            <span   id="error-common"></span>
        </div>
        <div class="panel-body"> 
            <form action="#" id="utility_update" autocomplete="off" data-id="{{$user->id}}">
                ...
                <div class="row">
                   ...
                   <div class="form-group col-md-6" id="mobilebox">
                        ...
                        <input id="mnumber" style="box-shadow: none; width: 100%;    padding: 10px;   border: none;border-bottom: 1px solid #ddd;" name="mnumber" class="validate"  type="text" class="form-control" placeholder="Enter Mobile No" value="{{$user->created_usercountries[0]->mobile_number}}">
                        <span  class="help-block"></span>   
                    </div>  
                </div>
                 <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12 text-right">
                        <button type="submit" id="user_save" class="btn btn-primary legitRipple">Save Utility <i class="icon-paperplane position-right"></i></button>
                    </div>  
                </div>
                <!-- /* Form action -->
            </form>
...
@section('js')
    ...
    <script type="text/javascript" src="{{asset('Modules/Utility/Resources/assets/js/AdminUtilityControles.js')}}"></script>
