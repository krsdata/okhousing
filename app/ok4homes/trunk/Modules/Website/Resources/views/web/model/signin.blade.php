                    ...
                    <div class="sibox">
                        ...
                        <div class="form-box">
                            ...
                            <ul class="signin-items">
                                ...
                                <li><a href="#" data-toggle="modal" data-target=".loginModal-box" data-dismiss="modal" > Forgot password</a></li>
                            </ul>
                            <button class="signbtn">Sign in</button>
                            <p class="txt-create-ac">Create an account <button data-toggle="modal" data-target=".signup-box" data-dismiss="modal" class="signup-btn">Sign up</button></p>
                        </div>
                    </div>
                    </form>
                </div>
