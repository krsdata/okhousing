                                ...
                                <div class="row">
                                    ...
                                    @endforeach
                                        ...
                                        <div id="property_prize"> 
                                            <div class="input-field" >
                                                <input id="property_prize" name="property_prize" type="number" class="validate" min="0"  required>
                                    ...
                                    <div class="col-sm-12 col-md-12">
                                         <div class="input-box" id="location">
                                              ...
                                              <input id="pac-input" name="location" type="text" placeholder="Enter a location" class="validate" style="font-size: 12px;" class="validate" required >
                             ...
                             <div class="step-form-box">
                                ...
                                <div class="row">    
                                    <div class="col-sm-3 col-xs-12">    
                                       <div  id="bedroom">
                                            <div class="input-field">
                                                <input type="number" min="0" id="bedroom1" name="bedroom" required>
                                    ...
                                    <div class="col-sm-3 col-xs-12">    
                                       <div  id="bathroom">
                                            <div class="input-field">
                                                <input type="number" min="0" id="bathroom1" name="bathroom" required>
            ...
            <div class="modal-dialog modal-sm signin ed_popup " role="document">
                <div class="modal-content">
                    ...
                    <div class="signin-box">
                        ...
                        <h4><img src="{{asset('public/images/register.png')}}" alt="" id="mypro" class="mypro"/><i class="icon fa fa-check"></i> Success!</h4>
