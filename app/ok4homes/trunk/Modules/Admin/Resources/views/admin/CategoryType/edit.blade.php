...
<ul class="breadcrumb">
        ...
        <li><a href="{{ URL::to('o4k/CategoryType')}}"><i class="icon-list position-left"></i>Property Type </a></li>
...
@section('heading')
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li><a href="{{URL('/o4k/CategoryType')}}"><i class="icon-list position-left"></i> Property Type </a></li>
     ...
     <div class="page-header-content">
        <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> -Property Type List <small>Hello, {{Auth::guard('admin')->user()->name}}!</small></h4>
        </div>
...
@section('content') 
    <div class="panel panel-flat">
        ...
        <div class="panel-heading">
            <h5 class="panel-title">Edit Property Type <a class="heading-elements-toggle"> <i class="icon-more"></i> </a></h5>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 text-right">
                           <!-- <button type="reset" class="btn btn-default legitRipple" id="reset">Reset <i class="icon-reload-alt position-right"></i></button>-->
                            <button type="submit" id="CategoryType_list_save" class="btn btn-primary legitRipple">Save Property Type<i class="icon-paperplane position-right"></i></button>
                        </div>  
                    </div>
               <!-- /* Form action -->
                </form>
