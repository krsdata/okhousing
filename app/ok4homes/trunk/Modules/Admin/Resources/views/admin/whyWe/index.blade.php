 ...
 @section('heading')
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li class="active"><a href="{{URL('/o4k/CategoryType')}}"><i class="icon-list position-left"></i>Why We </a></li>
 ...
 @section('content') 
    <div class="panel panel-flat">
        ...
        <div class="panel-heading">
            <h5 class="panel-title">Why We<a class="heading-elements-toggle"> <i class="icon-more"></i> </a></h5>
        </div>
