...
@section('content') 
    <div class="panel panel-flat">
        ...
        <div class="panel-heading">
            <h5 class="panel-title">Create News Updates <a class="heading-elements-toggle"> <i class="icon-more"></i> </a></h5>
        </div>
		<div class="panel-body">
		<!--- Form -->
        <div class="row">
            <div class="col-md-12">
                <form  id="NewsUpdates_list_create" autocomplete="off" > 
                    ...
                    <div class="row">
                     ...
                     <div class="lang_section" ><div class="langtitle" style="display:none;"><legend class="text-bold ">Add News Description</legend></div></div>
